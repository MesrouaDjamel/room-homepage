...
const handleMenuOpen = () =>{
  ...
  return (
    <header className={`absolute ${isMenuOpen && "bg-white md:bg-transparent"}  top-0 left-0 w-full h-28 px-6 py-12 `}>
      {/* Mobile */}
        ...
        {isMenuOpen ? (
          <div className={cn(`flex items-center  justify-between`)}>
            <svg
              ...
              className="cursor-pointer fill-black hover:fill-pink-800 transition-all duration-300 ease-in-out"
            >
              <path
          ...
          <div className={cn(`flex gap-28`)}>
            <svg
              className="md:hidden cursor-pointer fill-white hover:fill-black transition-all ease-in-out duration-300"
              width="20"
              height="14"
              onClick={handleMenuOpen}
            >
